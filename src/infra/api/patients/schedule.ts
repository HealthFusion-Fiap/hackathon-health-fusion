...
import {
  SchedulePatientController,
} from '@/adapters/controllers/schedulePatient.controller';
import {
...
const schedulePatientUseCase = new SchedulePatientUseCase(scheduleRepository);
